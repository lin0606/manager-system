```js
yarn create @vitejs/app manager 创建项目
```

### mongo语法

连接MongoDB方法【https://blog.csdn.net/qq_38111015/article/details/105955635】
...
创建：db.users.insertOne({userId:1,userName:'llr',age:20,score:100})

查找：db.users.find() 	eg:db.users.find({age:{$gte:40}})  //users年龄大于40

删除某一个：db.users.deleteOne({key:value})

更新：db.users.update({age:{$gte:40}},{$set:{score:600}},false,true)



![image-20220106141055057](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20220106141055057.png)
